...
<script>
    ...
    if(msg==1){
        swal({   title: "Success!",   text: "Consumer Update Action Successful!",   type: "success",   confirmButtonText: "Back to Home" },
       function (confirmed) {
                    //var confirmed = true;
                    if (confirmed) {
                                      window.location.href = "<?php echo site_url() ?>/home/editConsumer";//reload page to see the effect of delete
                                    };
