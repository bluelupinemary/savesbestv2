        ...
        <div class="row">
                 ...
                 <div class="panel panel-primary user-profile">
				  		<div class="panel-heading">
                            <center><h4>LIST OF RECEIVED CODES</h4></center>
				  		</div>
                    ...
                    <table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="95%">
                      <thead>
                        <tr>
                            <th>#</th>
                            <th>Student Name</th><th>Section</th><th>File Name</th><th>Date Submitted</th><th>Action</th>
                        ...
                        foreach($codes as $value){
                            echo "<tr><td>".$i."</td>
                                 ...
                                 <td><button class='download_code btn-success' value='".$value->exerid."'>Download</button>                                   </td>
                                 </tr>";
