                 ...
                 <div class="panel panel-primary user-profile">
                    ...
                    <table id="myTable" class="table table-striped table-bordered table-hover" cellspacing="0" width="95%">
                      <thead>
                        <tr>
                            <th>#</th>
                            <th>Code</th><th>Student Name</th><th>Adress</th><th>Username</th><th>Action</th>
                           ...
                           <?php
                            ...
                            foreach($results as $result){
                               ...
                               // echo validation_errors('<p class="error">' );
                                   ...
                                   // echo validation_errors('<p class="error">' );
                                //echo form_open('ManageStudent/removeStudentFromSection');
                                echo "<input type='hidden' id='studentid' name='studentid'                                            value='".$result['studentid']."'/>";
                                echo "<input type='hidden' id='sectionid' name='sectionid'                                            value='".$result['sectionid']."'/>";
                                
                                echo "<center><button id='removeStudentFromSection' class='btn btn-danger btn-xs'                                           value='".$result['studentid']."'>Remove Student</button></center>".
                                    "</form>".
                                    "</td>".
