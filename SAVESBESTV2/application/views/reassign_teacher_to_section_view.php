					...
					<div class="panel panel-primary user-profile"  style="min-height:400px; width:60%;">
				  		...
				  		<div class="panel-body">
                              ...
                              <div class="reg_form">
                                ...
                                <?php echo form_open('ManageSection/editReassignTeacherToSection'); ?>
                                ...
                                <div class="col-md-4">
                                       ...
                                       <div class="form-group">
                                           ...
                                           <select class="form-control" id="teacherid" name="teacherid">
                                                <?php
                                                    ...
                                                    echo "<option value='".$tdata['userid']. "'>".$tdata['name']."</option>";
                                                    }
                                               ?>
                                    ...
                                    <input type="hidden" name="usertype" id="usertype" value="2" /><!--default to value 2 because teacher usertype is always assigned-->
                                      <p>
                                      <input type="submit" class="btn btn-success btn-lg" value="Assign Teacher" />
                                      </p>
                                </div>
                                </form>
                                </div><!--div regform-->
