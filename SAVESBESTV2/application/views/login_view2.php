...
<!--
This file is similar to login_view.php except that this file accesses the devtools > image directory differently.
-->
<body>
            ...
            <div class="panel panel-default" style="background-color: rgba(255,255,255,0.3);">
                ...
                <div class="panel-body" style="">
                    ...
                    <?php  echo form_open('VerifyLogin2',array('class' => 'navbar-form navbar-right')); ?>
                            Username: <div class="sign-in-panel form-group input-group">
                                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                 <input type="text" placeholder="Username" size="25"class="form-control" id="username" name="username"/>
                            </div>
                                  <br/>
                            Password: <div class="sign-in-panel form-group input-group">
                      ...
                      <?php if(validation_errors()):?>
                        <br/>
                        <label style="color:red;padding-top:3%;"><?php echo validation_errors();?></label>
                        <?php endif; ?>
                      </form>
