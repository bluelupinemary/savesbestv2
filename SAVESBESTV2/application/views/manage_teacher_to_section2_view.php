					...
					<div class="panel panel-primary user-profile"  style="min-height:400px; width:60%;">
				  		...
				  		<div class="panel-body">
				  			<div class="row" id="reg">
                                ...
                                <div class="col-md-4">
                                    <p>
                                        <input type="text" id="sname" name="sname" value="<?php echo set_value('sname'); ?>" />
                                    </p>
                                    <p>
                                        <input type="text" id="scode" name="scode" value="<?php echo set_value('scode'); ?>" />
                                    </p>
                                    <p>
                                        <input type="text" id="maxnum" name="maxnum" value="<?php echo set_value('maxnum'); ?>" />
                                    </p>
                                    <input type="hidden" id="sectionid" name="sectionid" value="<?php echo set_value('sectionid'); ?>">
                                    
                                      <p>
                                      <input type="submit" class="greenButton" value="Update Section" />
                                      </p>
                                </div>
                                </form>
                                </div><!--div regform-->
