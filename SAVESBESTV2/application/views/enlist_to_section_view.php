                 ...
                 <div class="panel panel-primary user-profile">
                    ...
                    <table id="myTable" class="table table-striped table-bordered table-hover" cellspacing="0" width="95%">
                      <thead>
                        <tr>
                            <th>#</th>
                            <th>Section Name</th><th>Section Code</th><th>Max Number</th><th>Teacher</th><th>Action</th>
                        ...
                        <tbody>
                           ...
                           <?php
                            ...
                            foreach($results as $result){
                                ...
                                //echo form_open('ManageSection/enlistToSection');
                                
                                echo "<input type='hidden' id='sectionid' name='sectionid'                                            value='".$result['sectionid']."'/>";
                                echo "<input type='hidden' id='userid' name='userid'                                            value='".$userid."'/>";
                                
                                $enlistarr = array(
                                    "secid" => $result['sectionid'],
                                    "uid" => $userid,
                                );
                                $arr = implode(",", $enlistarr);
                            //    echo "<center><input type='submit' class='btn btn-warning'                                           value='".$arr."' id='enlisttosecbutton'/></center>".
                                    echo "<center><button class='btn btn-warning'                                           value='".$result['sectionid']."' id='enlisttosecbutton'>Enlist</button></center>".
                                    "</form>".
                                    "</td>".
