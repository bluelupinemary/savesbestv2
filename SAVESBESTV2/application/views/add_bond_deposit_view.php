       ...
       <div class="row">
         ...
         <div class="panel panel-primary user-profile"  style="min-height:400px; width:60%;">
             <div class="panel-heading">
                <center><h4>ADD BOND DEPOSIT TO CONSUMER</h4></center>
             </div>
             <div class="panel-body">
               <div class="row" id="reg">
                  <div class="reg_form">
                               <?php echo form_open('Consumer/insertBondDeposit'); ?>
                               <div class="col-md-12" style="text-align: center" form-group>
                                    <p >
                                    ...
                                    <p >
                                          <label for="bondAmount">Bond Deposit:</label>
                                          <?php 
                                            echo 'Php <input type="number" required id="bondAmount" size="10" name="bondAmount" onkeyup="this.value=this.value.replace(/[^\d]/,\'\')" value=""/>';
                                          ?>
                                    </p>
                                    ...
                                    <p><br>
                                     ...
                                     <input type="submit" class="btn btn-success btn-lg" value="Add Bond Deposit" />
                                     </p>
