                    ...
                    <table id="myTable" class="table table-striped table-bordered table-hover" cellspacing="0" width="95%">
                        <thead>
                            <tr>
                                ...
                                <th>Last Reading Date</th><th>Consumer Type</th><th style="padding-left:5%;padding-right:3%;">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                           ...
                           <?php
                            ...
                            foreach($results as $result){
                                ...
                                if($result['last_bill_month']==1){
                                    $last_bill_month="Jan";
                                }else if($result['last_bill_month']==2){
                                    $last_bill_month="Feb";
                                }else if($result['last_bill_month']==3){
                                    $last_bill_month="Mar";
                                }else if($result['last_bill_month']==4){
                                    $last_bill_month="Apr";
                                }else if($result['last_bill_month']==5){
                                    $last_bill_month="May";
                                }else if($result['last_bill_month']==6){
                                    $last_bill_month="Jun";
                                }else if($result['last_bill_month']==7){
                                    $last_bill_month="Jul";
                                }else if($result['last_bill_month']==8){
                                    $last_bill_month="Aug";
                                }else if($result['last_bill_month']==9){
                                    $last_bill_month="Sep";
                                }else if($result['last_bill_month']==10){
                                    $last_bill_month="Oct";
                                }else if($result['last_bill_month']==11){
                                    $last_bill_month="Nov";
                                }else if($result['last_bill_month']==12){
                                    $last_bill_month="Dec";
                                }
                               ...
                               //echo "<tr class='clickable-row' data-href='viewUserProfile'".
                                ...
                                "<td>".$result['reading_id']."</td>".
                                "<td>".$result['account_no']."</td>".
                                "<td>".$result['fullname']."</td>".
                                "<td>".$result['address']."</td>".
                                "<td>".$last_bill_month." ".$result['last_bill_year']."</td>".
                                "<td>".$consumertype.
                                        //"<td>".
