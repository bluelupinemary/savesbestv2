var plantArr = [];
var keptPlantsArr = '';
var post_path = "http://localhost/IBS-PROJ/index.php/home/";
        ...
        swal({
                ...
                closeOnConfirm: false 
                    ...
                    if(confirmed){
                        ...
                        //window.open("http://localhost/IBS-PROJ/index.php/home/grasslandPage",'_self');
                        window.location.href = "agrilandPage";//reload page to see the effect of deletes
                    }
        });//end of swal
...
$(document).ready(function(){
	...
	$('#keepPlantsBtn').click(function(){
        ...
        for(var c=0;c<totalPlantsArr.length;c++){
            ...
            if(totalPlantsArr[c]!="" && totalPlantsArr[c]!= null && totalPlantsArr[c].length >= 1 && totalPlantsArr[c]!='list'){
                totalNumPlants += 1;
            }
        }
