                                  ...
                                  swal({title:"Requested!", text:"Enlistment Request to section successful.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                            ...
                                            window.location.href = "";//reload page to see the effect of delete
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    //$.post("http://localhost/IBS-PROJ/index.php/ManageStudent/removeStudentFromSection", 
                                      $.post("removeStudentFromSection", 
                                      {
                                        studentid: student_id,                                       
                                      }
                                      );
                                  swal({title:"Removed!", text:"Student was removed successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                        ...
                        swal("Cancelled", "Remove student cancelled", "error");
                    }
                });
    });  
