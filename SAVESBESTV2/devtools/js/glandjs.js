        ...
        swal({
                ...
                closeOnConfirm: false 
                    ...
                    if(confirmed){
                        ...
                        window.location.href = "grasslandPage";//reload page to see the effect of deletes
        ...
        if(totalNumPlants > maxNumPlantsForExpi){
            ...
            swal({title:"Success", text:"Plants were kept safely."+"\n Click 'Back to Main Map' button to go explore the Map.", type:"success",confirmButtonText:'Alright!'},
                                      function(confirmed){
                                        ...
                                        window.location.href = "grasslandPage";//reload page after keeping the plants
                                   
                                        }            
                                      }); 
        }//end of else

        //console.log("*****TOTAL COUNT OF PLANTS TO BE SAVED: "+totalNumPlants);
        /*for(var i=0;i<plants.length;i++){
            console.log(plants[i]);
            //concat plants to string first
            if(i==(plants.length)-1){
                    plantsString = plantsString.concat(plants[i]);    
            }else{
                    plantsString = plantsString.concat(plants[i],"/");
            }
