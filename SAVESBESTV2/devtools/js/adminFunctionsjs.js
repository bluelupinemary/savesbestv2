...
$(document).ready(function(){
    ...
    /*$clickrow.click(function() {
       var data = $table.dataTable().row.data();
        alert('clicked '+data[0]);
    });*/
...
//}
   ...
   $deluserbutton.click(function(){
     ...
     $delsecbutton.click(function(){
       ...
       var section_id = $(this).val(); // get value (id) in delete button
       //alert(section_id);
         swal({
                    title: "Are you sure?",
                    text: "All STUDENTS AND TEACHERS in this section will be removed. \nYou will not be able to recover the deleted section! Are you sure?",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: 'btn-danger',
                    confirmButtonText: 'Yes, delete it.',
                    ...
                    if (confirmed) {
                                  ...
                                  swal({title:"Deleted!", text:"Section has been deleted successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                                        //window.location.href = "http://localhost/IBS-PROJ/index.php/home/deleteSection";//reload page to see the effect of delete
