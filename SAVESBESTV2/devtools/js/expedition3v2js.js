$(document).ready(function(){
	...
	$('#submitPlants').click(function(){
		...
		swal({
                title: "Handing the plants over to the foreman...are you sure?",   
                    ...
                    if(confirmed){
                                  ...
                                  swal({title:"Your Score: "+totalScore, text:"Submitted!"+"\n Click Okay button to exit.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                       ...
                                       window.location.href = "expedition3Pagev2";//reload page to see the effect of delete
