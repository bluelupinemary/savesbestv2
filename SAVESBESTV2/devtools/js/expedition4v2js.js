$(document).ready(function(){
	...
	$('#submitPlants').click(function(){
		...
		swal({
                title: "Handing the plants over to the farmers...are you sure?",   
                                  ...
                                  swal({title:"Your Score: "+totalScore, text:"Submitted!"+"\n Click Okay button to exit.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                          ...
                                          //$.post("http://localhost/IBS-PROJ/index.php/home/expedition4Pagev3", 
                                          	$.post("expedition4Pagev3", 
                                            {
                                              ts:score,
                                              vtype: "save_score",
                                            }
                                            );
                                       		//window.location.href = "http://localhost/IBS-PROJ/index.php/home/expedition4Pagev2";//reload page to see the effect of delete
                                       		window.location.href = "expedition4Pagev2";//reload page to see the effect of delete
