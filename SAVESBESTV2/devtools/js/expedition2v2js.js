$(document).ready(function(){
	...
	$('#submitPlants').click(function(){
		...
		swal({
                title: "Handing the plants over to the queen...are you sure?",   
                                  ...
                                  swal({title:"Your Score: "+totalScore, text:"Submitted!"+"\n Click Okay button to exit.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                          ...
                                          //$.post("http://localhost/IBS-PROJ/index.php/home/expedition2Pagev3", 
                                          	$.post("expedition2Pagev3", 
                                            {
                                              ts:score,
                                              vtype: "save_score",
                                            }
                                            );
                                          //window.open("http://localhost/IBS-PROJ/index.php/home/expedition1Pagev3",'_self');
                                       //window.location.href = "http://localhost/IBS-PROJ/index.php/home/expedition2Page";//reload page to see the effect of delete
                                       window.location.href = "expedition2Page";//reload page to see the effect of delete
