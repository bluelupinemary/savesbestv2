$(document).ready(function(){
	...
	$('#submitPlants').click(function(){
		...
		swal({
                title: "Handing the plants over to the prince...are you sure?",   
                                  ...
                                  swal({title:"Your Score: "+totalScore, text:"Submitted!"+"\n Click Okay button to exit.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                          ...
                                          //$.post("http://localhost/IBS-PROJ/index.php/home/expedition5Pagev3", 
                                          	$.post("expedition5Pagev3", 
                                            {
                                              ts:score,
                                              vtype: "save_score",
                                            }
                                            );
                                       		//window.location.href = "http://localhost/IBS-PROJ/index.php/home/expedition5Pagev2";//reload page to see the effect of delete
                                       		window.location.href = "expedition5Pagev2";//reload page to see the effect of delete
