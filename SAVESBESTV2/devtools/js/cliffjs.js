    ...
    if(keepPlantsList==''){
        ...
        swal({
                ...
                closeOnConfirm: false 
                    ...
                    if(confirmed){
                        //$.post("http://localhost/IBS-PROJ/index.php/home/cliffPage", 
                        $.post("cliffPage", 
                                            {
                                                ts:keepPlantsList,
                                                vtype: "keep_plants2",
                        ...
                        //window.location.href = "http://localhost/IBS-PROJ/index.php/home/cliffPage";//reload page to see the effect of deletes
                        window.location.href = "cliffPage";//reload page to see the effect of deletes
