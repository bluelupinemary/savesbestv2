         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/home/deleteUserProfileByAdmin", 
                                      {
                                        userid: user_id,
                                       // vtype: "get_section",
                                      }
                                  ...
                                  swal({title:"Deleted!", text:"User has been deleted successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                                        window.location.href = "http://127.0.0.1/IBS-PROJ/index.php/home/deleteUserProfileByAdmin";//reload page to see the effect of delete
                                    // }
                                        }            
                                      }
         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/ManageSection/deleteSectionInfo", 
                                      {
                                  ...
                                  swal({title:"Deleted!", text:"Section has been deleted successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                                        window.location.href = "http://127.0.0.1/IBS-PROJ/index.php/home/deleteSection";//reload page to see the effect of delete
                                    // }
                                        }            
                                      }
         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/ManageSection/enlistToSection", 
                                      {
                                       sectionid:sec_id,
                                  ...
                                  swal({title:"Requested!", text:"Enlistment Request to section successful.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
		                                        ...
		                                        window.location.href = "http://127.0.0.1/IBS-PROJ/index.php/home";//reload page to see the effect of delete
         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/ManageStudent/approveEnlistRequest", 
                                      {
                                  ...
                                  swal({title:"Enlisted!", text:"Student has been enlisted successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                                        window.location.href = "http://127.0.0.1/IBS-PROJ/index.php/home/listPendingEnlistmentRequests";//reload page to see the effect of delete
                                    // }
                                        }            
                                      }
         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/ManageStudent/disapproveEnlistRequest", 
                                      {
                                        studentid: student_id,
                                       // vtype: "get_section",
                                      }
         ...
         swal({
                ...
                function (confirmed) {
                    ...
                    if (confirmed) {
                                    ...
                                    $.post("http://127.0.0.1/IBS-PROJ/index.php/ManageStudent/removeStudentFromSection", 
                                      {
                                        studentid: student_id,
                                       // vtype: "get_section",
                                      }
                                  ...
                                  swal({title:"Deleted!", text:"Student was removed successfully.", type:"success",confirmButtonText:'Okay'},
                                      function(confirmed){
                                        if(confirmed){
                                    //function(){
                                       window.location.href = "http://127.0.0.1/IBS-PROJ/index.php/home/listAllStudentOfTeacher";//reload page to see the effect of delete
                                    // }
                                        }            
                                      }
