...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header lighten-blue">
          ...
          <a class="navbar-brand" href="#"><b>Toybox PL</b></a>
        </div>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Welcome!</h1>
        <p>Toybox Programming Language ...</p>
        <div class="row">
        		<div class="col-md-4">
        			<p><img src="images/toybox_icon.png" alt="image goes here"></img></p>
        		</div>
        		<div class="col-md-4">
        		</div>
        		<div class="col-md-4">
	...
	?>
      ...
      <footer>
        <p>&copy; Institute of Computer Science. UPLB. Toybox Programming Language Web Application 2015 </p>
      </footer>
    </div> <!-- /container -->
